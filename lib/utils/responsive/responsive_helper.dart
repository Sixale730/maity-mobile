...
/// Using official Maity brand color palette
class ResponsiveHelper {
  ...
  // === MAITY OFFICIAL COLOR PALETTE ===

  // Background colors
  static const Color backgroundPrimary = Color(0xFF000000); // Fondo Oscuro - Negro puro
  ...
  static const Color backgroundLight = Color(0xFFE7E7E9); // Fondo Claro

  // Primary accent colors (Rosa Maity)
  static const Color purplePrimary = Color(0xFFFF0050); // Color Principal - Rosa Maity
  static const Color purpleSecondary = Color(0xFF485DF4); // Color Secundario - Azul Maity
  static const Color purpleAccent = Color(0xFFCC0040); // Darker pink for pressed states
  static const Color purpleLight = Color(0xFFFF3373); // Lighter pink for highlights

  // Text colors
  static const Color textPrimary = Color(0xFFFFFFFF); // Blanco - textos sobre fondos oscuros
  ...
  // Semantic colors
  static const Color successColor = Color(0xFF1BEA9A); // Color Éxito - Verde Maity
  static const Color warningColor = Color(0xFFF59E0B); // Amber warning
  static const Color errorColor = Color(0xFFFF0050); // Rosa como error (consistente con marca)
  static const Color infoColor = Color(0xFF485DF4); // Azul Maity para info
