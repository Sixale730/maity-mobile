...
//                           border: Border.all(
//                             color: const Color(0xFF667EEA).withValues(alpha: 0.3 - _scanAnimation.value * 0.3),
//                             width: 2,
//                           ),
//                         ),
//                       );
...
//                   decoration: BoxDecoration(
//                     color: isSelected ? const Color(0xFF667EEA).withValues(alpha: 0.2) : Colors.white.withValues(alpha: 0.05),
//                     borderRadius: BorderRadius.circular(12),
//                     border: Border.all(
//                       color: isSelected ? const Color(0xFF667EEA) : Colors.white.withValues(alpha: 0.1),
