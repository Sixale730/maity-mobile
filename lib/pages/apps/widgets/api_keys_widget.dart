                    ...
                    IconButton(
                      ...
                      onPressed: () {
                        showDialog(
                          ...
                          builder: (context) => AlertDialog(
                            backgroundColor: const Color(0xFF1F1F25),
                            title: const Text('Maity API Keys'),
                            content: const Text(
                              'API Keys are used for authentication when your app communicates with the Maity server. They allow your application to create memories and access other Maity services securely.',
                            ),
                            actions: [
                              TextButton(
