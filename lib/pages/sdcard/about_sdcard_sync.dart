            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  Center(
                    child: Text(
                      l10n?.howDoesItWork ?? 'How does it work?',
                  ...
                  Text(
                    l10n?.sdCardSyncDesc ?? 'SD Card Sync will import your memories from the SD Card to the app',
                  ...
                  Text(
                    l10n?.sdCardStep1 ?? 'Checks for audio files on the SD Card',
                    textAlign: TextAlign.center,
                  ...
                  const SizedBox(height: 8),
                  Text(
                    l10n?.sdCardStep2 ?? 'Maity then syncs the audio files with the server',
                    textAlign: TextAlign.center,
                    style: const TextStyle(color: Colors.white, fontSize: 16),
                  ),
                  const SizedBox(height: 18),
                  ...
                  const SizedBox(height: 8),
                  Text(
                    l10n?.sdCardStep3 ?? 'The server processes the audio files and creates memories',
                    textAlign: TextAlign.center,
                    style: const TextStyle(color: Colors.white, fontSize: 16),
                  ),
                ],
