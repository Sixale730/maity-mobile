  ...
  Future<TranscriptSegmentSocketService?> socket({
    ...
    try {
      ...
      if (customSttConfig != null && customSttConfig.isEnabled) {
        // Use DIRECT mode (without Omi backend composite) to bypass Firebase auth issues
        // This sends audio directly to Deepgram without requiring Omi backend connection
        _socket = TranscriptSocketServiceFactory.createCustomSttOnly(
          sampleRate,
          codec,
          language,
          customSttConfig,
